...
class MCStandaloneGPUSketchAlg;
class SketchSubgraph {
 private:
  ...
  CudaStream<MCStandaloneGPUSketchAlg>** cuda_streams = nullptr;
 ...
 public:
  ...
  void initialize(MCStandaloneGPUSketchAlg *sketching_alg, int graph_id, node_id_t _num_nodes,
...
class MCStandaloneGPUSketchAlg : public MCSketchAlg {
private:
...
public:
  MCStandaloneGPUSketchAlg(node_id_t num_nodes, size_t num_updates, int num_threads, int num_reader_threads,
                int num_batch_per_buffer, SketchParams sketchParams, int num_subgraphs, int max_sketch_graphs, 
                size_t initial_sketch_graphs, int k, size_t sketch_bytes, CCAlgConfiguration config)
     : MCSketchAlg(num_nodes, sketchParams.seed, max_sketch_graphs, config),
       ...
       initial_sketch_graphs(initial_sketch_graphs),
       k(k),
  ...
  void print_subgraph_edges() {
    ...
    std::cout << "  Note: For Adj. list, it is number of edges instead" << std::endl;
